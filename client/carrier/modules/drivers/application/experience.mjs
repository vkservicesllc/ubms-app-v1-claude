...
(() => {
  ...
  if (experience?.firstDate)
    $calendar.startDate.calendar('set date', new Date(moment(experience.firstDate).toDate()));
  ...
  if (experience?.firstDate)
    $calendar.endDate.calendar('set date', new Date(moment(experience.lastDate).toDate()));
