...
(() => {
    ...
    const $denied = $(CS.dlDenied),
        $revoked = $(CS.dlRevoked);
    const $deniedExpl = $(TS.dlDeniedExpl),
        $revokedExpl = $(TS.dlRevokedExpl);
    ...
    $commercial.prop('checked', dl.commercial).on('change', function () {
        let value = 'N',
            disabled = true,
            action = 'hide';
    ...
    $denied.prop('checked', dl.denied).on('change', function () {
        let value = 'N',
            disabled = true,
            action = 'hide';
    ...
    $revoked.prop('checked', dl.revoked).on('change', function () {
        let value = 'N',
            disabled = true,
            action = 'hide';
