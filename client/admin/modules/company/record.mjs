...
const handleChange = (props = {}) => {
    ...
    $.ajax('/api/unique/company', {
        ...
        success(response) {
            ...
            if (input && !unique && !original) action = 'failed';
...
$form.submit(function (event) {
    ...
    if (!formValid())
        $tip.form.html(
            '<i class="fas fa-close"></i>&nbsp; Records can not have dublicates<br /><i class="fas fa-close"></i>&nbsp; Data can not be submitted',
        );
