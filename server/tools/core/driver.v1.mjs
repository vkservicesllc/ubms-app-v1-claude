...
class Driver extends Individual {
    constructor(data = {}) {
        ...
        this.applications = async (session, ) => {
            let error = null // sessionError(session, { branches: [ 'carrier', 'driver' ] })
...
class Application {
    ...
    modify = async (session, step, data) => {
        let modified = false,
            error = null // sessionError(session, { branches: [ 'carrier', 'driver' ] })
    ...
    certify = async session => {
        let modified = false,
            error = null // sessionError(session, { branches: [ 'driver' ] })
    ...
    delete = async session => {
        let deleted = false,
            error = null // sessionError(session, { branches: [ 'carrier' ] })
    ...
    identity = async session => {
        let error = null // sessionError(session, { branches: [ 'carrier' ] })
        if (error) return { error }
