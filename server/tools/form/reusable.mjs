...
const addrField = (prop, mail) => (mail !== null ? `${mail ? 'mail' : 'physical'}[${prop}]` : prop);

export const createIdForm = (props = {}, arr = false) =>
  createForm({
    target: 'id',
    name: '_id' + (arr ? '[]' : ''),
    ...props,
...
export const createPersonNameForm = (flag, props = {}) => {
  ...
  switch (flag) {
    ...
    case 'last':
      name += 'Name';
      sanitizer = [(value) => patterns.replace(value, 'name'), (value) => value || null];
      break;
    case 'prefix':
    case 'suffix':
      type = 'select';
...
export const createGenderForm = (props = {}) =>
  createForm({
    target: 'gender',
    group: 'gender',
    type: 'select/radio',
...
export const createMaritalStatus = (props = {}) =>
  createForm({
    target: 'marital',
    group: 'marital',
    type: 'select/radio',
...
export const createPhoneForm = (props = {}) =>
  createForm({
    target: 'phone',
    mode: 'tel',
    name: 'phone',
...
export const createUsStateForm = (props = {}) =>
  createForm({
    emptyOpt,
    ...props,
    type: 'select',
...
export const createAddressForm = (props = {}, options) => {
  ...
  return createForm({
    ...
    required: idx === 1,
    label: idx === 1 ? 'Street Address' + (mail === true ? ' / PO Box' : '') : 'Address #2',
    ...
    validator: {
      sanitizer: (value) => {
        ...
        if (idx === 1) value = value.replace(patterns.match.addr2, '').trim();
...
export const createAddrZipForm = (props = {}, mail = null) =>
  createForm({
...
export const createAddrCityForm = (props = {}, mail = null) =>
  createForm({
...
export const createAddrStateForm = (props = {}, mail = null) =>
  createUsStateForm({
...
export const createEmailForm = (props = {}) =>
  createForm({
    target: 'email',
    name: 'email',
    label: 'Email',
...
export const createWebsiteForm = (props = {}) =>
  createForm({
    target: 'website',
    name: 'website',
    label: 'Website',
...
export const createDateForm = (props = {}, optional) => {
  ...
  if (props?.required && optional === true) validator.optional = true;
...
export const createDobForm = (props = {}) =>
  createDateForm({
    target: 'dob',
    name: 'dob',
    label: 'Date of Birth',
...
export const createSinceForm = (props = {}) =>
  createDateForm({
    target: 'since',
    name: 'since',
...
export const createUntilForm = (props = {}) =>
  createDateForm({
    target: 'until',
    name: 'until',
...
export const createSsnForm = (props = {}) =>
  createForm({
    target: 'ssn',
    mode: 'numeric',
    name: 'ssn',
...
export const createYesNoForm = (props = {}, optional = false, type = 'radio') =>
  createForm({
    type,
    ...
    validator: {
      sanitizer: (value) =>
        value !== '-' ? value === 'Y' || value === '1' || value === 'on' : null,
      optional,
    },
  });

export const createCheckForm = (props = {}) =>
  createForm({
    type: 'checkbox',
    ...props,
    validator: {
