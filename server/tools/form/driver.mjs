...
export const createDlCommercialFrom = (props = {}) =>
    createYesNoForm({
        target: 'dlCommercial',
        group: 'dlCategory',
        name: 'commercial',
...
export const createDlStateForm = (props = {}) =>
    createUsStateForm({
        target: 'dlState',
        group: 'driverLicense',
        name: 'state',
...
export const createDlNumberForm = (props = {}) =>
    createForm({
        target: 'dlNumber',
        group: 'driverLicense',
        name: 'number',
...
export const createDlClassForm = (props = {}) =>
    createForm({
        target: 'dlClass',
        group: 'driverLicense',
        name: 'class',
...
export const createDlIssForm = (props = {}) =>
    createDateForm({
        target: 'dlIss',
        group: 'driverLicense',
        name: 'issuedOn',
...
export const createDlExpForm = (props = {}) =>
    createDateForm({
        target: 'dlExp',
        group: 'driverLicense',
        name: 'expiresOn',
...
export const createDlEndrsForm = (props = {}) =>
    createForm({
        target: 'dlEndrs',
        group: 'driverLicense',
        type: 'textarea',
...
export const createDlRestrForm = (props = {}) =>
    createForm({
        target: 'dlRestr',
        group: 'driverLicense',
        type: 'textarea',
...
const createDlProblemExplForm = (target, name) =>
    createForm({
        selector: appSelector,
        target,
        group: 'driverLicense',
...
const createMecNumberForm = (props = {}) =>
    createForm({
        target: 'mecNumber',
        group: 'medCard',
        name: 'nrcme',
...
class DriverForm {
    constructor(options = {}) {
        getStaticProps(DriverForm).forEach(
            (target) => (this[target] = constructForm(DriverForm, target, options)),
        );
    }
...
class ApplicationForm {
    constructor(options = {}) {
        getStaticProps(ApplicationForm).forEach(
            (target) => (this[target] = constructForm(ApplicationForm, target, options)),
        );
    }
    ...
    static leadFirstName = createPersonNameForm('first', {
        selector: appSelector,
        target: 'leadFirstName',
        group: 'name',
    });
    static leadMiddleName = createPersonNameForm('middle', {
        selector: appSelector,
        target: 'leadMiddleName',
        group: 'name',
    });
    static leadLastName = createPersonNameForm('last', {
        selector: appSelector,
        target: 'leadLastName',
        group: 'name',
    });
    static leadSuffix = createPersonNameForm('suffix', {
        selector: appSelector,
        target: 'leadSuffix',
        group: 'name',
    });
    static leadGender = createGenderForm({
        selector: appSelector,
        target: 'leadGender',
        group: 'gender',
    });
    ...
    static teamPhone = createPhoneForm({
        selector: appSelector,
        target: 'teamPhone',
        group: 'teamPartner',
        name: 'teamPhone',
    ...
    static benefFirstName = createPersonNameForm('first', {
        selector: appSelector,
        target: 'benefFirstName',
    });
    static benefMiddleName = createPersonNameForm('middle', {
        selector: appSelector,
        target: 'benefMiddleName',
    });
    static benefLastName = createPersonNameForm('last', {
        selector: appSelector,
        target: 'benefLastName',
    });
    static benefSuffix = createPersonNameForm('suffix', {
        selector: appSelector,
        target: 'benefSuffix',
    });
            ...
            (target, options) => {
                ...
                switch (target) {
                    ...
                    case 'carrier/compliance':
                        fields = ['dui2', 'duiInDecade', 'criminal2', 'criminalExpl', 'dotDat2'];
                        break;
...
class ApplicationFileForm {
    constructor(options = {}) {
        getStaticProps(ApplicationFileForm).forEach(
            (target) => (this[target] = constructForm(ApplicationFileForm, target, options)),
        );
    }

    static dlCommercial = createDlCommercialFrom({
        selector: appFileSelector,
        group: 'dlCommercial',
        name: 'dl[commercial]',
    });
    static dlCommercial2 = createDlCommercialFrom({
        selector: appFileSelector,
        group: 'dlCommercial2',
        name: 'commercial',
    });
    ...
    static dlIss2 = createDlIssForm({
        selector: appFileSelector,
        target: 'dlIss2',
        name: 'issuedOn',
    });
    static dlExp2 = createDlExpForm({
        selector: appFileSelector,
        target: 'dlExp2',
        name: 'expiresOn',
    });
    ...
    static dlFirstName = createPersonNameForm('first', {
        selector: appFileSelector,
        target: 'dlFirstName',
        name: 'name[firstName]',
    });
    static dlMiddleName = createPersonNameForm('middle', {
        selector: appFileSelector,
        target: 'dlMiddleName',
        name: 'name[middleName]',
    });
    static dlLastName = createPersonNameForm('last', {
        selector: appFileSelector,
        target: 'dlLastName',
        name: 'name[lastName]',
    });
    static dlSuffix = createPersonNameForm('suffix', {
        selector: appFileSelector,
        target: 'dlSuffix',
        name: 'name[suffix]',
    });
    static dlGender = createGenderForm({
        selector: appFileSelector,
        target: 'dlGender',
        name: 'person[gender]',
    });
    static dlDob = createDobForm({
        selector: appFileSelector,
        target: 'dlDob',
        name: 'person[dob]',
    });
...
class EmploymentForm {
    constructor(options = {}) {
        getStaticProps(EmploymentForm).forEach(
            (target) => (this[target] = constructForm(EmploymentForm, target, options)),
        );
    }

    static id = createIdForm({ selector: appEmplSelector });
    static appId = createIdForm({
    ...
    static validate = (target = 'employer', checkbox = false) =>
        validate(EmploymentForm, () => {
            let fields = [];
...
export function vhlMMTData(vhlCode) {
    ...
    for (const type in vehicles) {
        ...
        for (const make in list) {
            ...
            sublist.forEach(
                (model) => (data[group][`${type}:${make}:${model}`] = `${make} ${model}`),
            );
        }
    }
...
export function descYears() {
    ...
    for (let i = 0; i < 30; i++) list[`:${year - i}`] = year - i;
