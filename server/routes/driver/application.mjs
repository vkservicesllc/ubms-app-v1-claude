...
/* Middleware */
import {
    applicationStart, applicationRegistration, applicationLogin, applicationProgress, applicationRehireProgress,
...
router.get('/:param?', applicationStart, applicationLogin, applicationProgress, applicationRehireProgress)
