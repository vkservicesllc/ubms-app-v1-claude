  ...
  try {
    ...
    if (step >= 5) {
      ...
      const values = {
        ...
        schPhone: application?.cdlSchool?.phone ? formatTel(application.cdlSchool.phone) : null,
    ...
    if (step >= 7) {
      ...
      options.operType = {
        radio: {
          solo: {
            input: { ...checkProps.input, checked: application?.preference?.operType === 's' },
            label: { ...checkProps.label },
          },
          team: {
            input: { ...checkProps.input, checked: application?.preference?.operType === 't' },
            label: { ...checkProps.label },
          },
        },
      };
