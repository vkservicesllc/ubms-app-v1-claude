...
router.use((req, res, next) => {
  ...
  res.hbs.set = async function (key, params = {}) {
    ...
    if (user) {
      ...
      if (user.unscoped) {
        hbs.teamDropdown =
          '<span class="item" id="team-item"><i class="universal access icon"></i> <small style="font-size: .55em;">Universal<br/>Access</small></span>';
        hbs.teamSelect = true;
      } else if (team) {
        hbs.team = {};
        ...
        for (const prop of props) hbs.team[prop] = team[prop];
