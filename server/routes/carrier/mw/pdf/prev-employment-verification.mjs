...
export default async (employment = {}, method) => {
  ...
  /* Consent Page */
  {
    ...
    x = marginX;
    y -= size.value * 1.5;
    consentPage.drawText('Signature', { x: x + 2, y, font: font.label, size: size.label * 0.9 });
    consentPage.drawLine({
      start: { x, y: y + 9 },
      end: { x: x + 240, y: y + 9 },
      color: color.line,
    ...
    x += numIdent;
    consentPage.drawText('Refusals to be tested (including adulterated or substituted results)', {
      x,
      y,
      font: font.label,
      size: size.text,
