...
export default async (carrier, application, addresses, violations, accidents, employers) => {
  ...
  /* Section 6 */
  {
    ...
    for (let i = 0; i < 5; i++) {
      ...
      text = 'Fatalities';
      drawCheckBox(page2, marginX + vLineX, y - fieldHeight / 1.5, fatalities === 'Yes', color);
      page2.drawText(text, {
        x: marginX + vLineX + 15,
        y: y - fieldHeight / 1.65,
        font: font.label,
  ...
  /* Section 9 */
  {
    ...
    for (let i = 0; i < 10; i++) {
      ...
      if (prevEmployer)
        ({ employer, phone, address, startedOn, position, earnings, fmcsr, dotDat, leftOn, rfl } =
          prevEmployer);
      ...
      vLineX += 140;
      drawCheckBox(emplPages[page], vLineX + padding * 2, y - offset.labelY - 2 - 2, fmcsr, color);
