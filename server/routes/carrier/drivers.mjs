    ...
    try {
        ...
        /* WORKFLOW */
        {
            ...
            if (application?.decision?.experience)
                options.experience = {
                    hidden: { input: { value: application.decision.experience } },
                };
            if (application?.decision?.position)
                options.apprPosition = {
                    hidden: { input: { value: application.decision.position } },
                };
        }
        ...
        /* ADDRESS */
        {
            ...
            if (hbs.addrLen) {
                hbs.addrMinDate = moment(addresses[0].since)
                    .clone()
                    .add(1, 'day')
                    .format('YYYY-MM-DD');
